		...
		<section className="px-6 py-16 md:py-20 space-y-10">
			<div className="space-y-3">
				...
				<p className="text-neutral-400 max-w-2xl leading-relaxed text-sm md:text-base">
					cuzbangs is a redirect engine that lets you search any site on the web
					using bangs, skipping homepages and jumping straight to the search
					results.
				</p>
			</div>
...
function StepCard({
	...
	return (
		<div
			className={`flex flex-col gap-6 rounded-2xl border bg-black/40 p-6 flex-1 transition-transform duration-300 hover:rotate-0 hover:scale-[1.03] ${tilt}`}
		>
