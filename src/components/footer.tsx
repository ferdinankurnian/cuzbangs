export function Footer() {
	...
	return (
		<footer className="relative px-6 py-10 md:p-10 border rounded-2xl overflow-hidden">
			...
			<div className="relative flex flex-col gap-8">
				...
				<div className="pt-6 border-t flex flex-col md:flex-row md:items-center md:justify-between gap-2 text-xs text-gray-500">
